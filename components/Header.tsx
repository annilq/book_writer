...
export default function Header() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? "bg-secondary shadow-md" : "bg-transparent"
        }`}
    >
      <div className="flex justify-between gap-2 p-4 sticky top-0 z-10">
